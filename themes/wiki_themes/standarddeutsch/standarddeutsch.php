...
Es gibt {if subcategory_total == '1'} 1 Unterkategorie{if:else} {subcategory_total} Unterkategorien{/if} für diese Kategorie
{/header}
...
{
	return <<<EOT
Es wurde eine neue Version für diese Beitrag vorgelegt: {title}

URL zum Ansehen der Version:  {path:view_revision}
URL zum Öffnen der Version:  {path:open_revision}
