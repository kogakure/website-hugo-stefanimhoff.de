...
server_port     = "9999"      # port for preview server eg. localhost:4000
...
task :generate do
  ...
  system "compass compile --css-dir #{source_dir}/assets/stylesheets"
  system "jekyll"
end
...
task :watch do
  ...
  system "compass compile --css-dir #{source_dir}/assets/stylesheets" unless File.exist?("#{source_dir}/stylesheets/screen.css")
...
task :new_post, :title do |t, args|
  ...
  open(filename, 'w') do |post|
    ...
    post.puts "author: \"Stefan Imhoff\""
...
task :new_page, :filename do |t, args|
  ...
  if args.filename.downcase =~ /(^.+\/)?(.+)/
    ...
    open(file, 'w') do |page|
      ...
      page.puts "author: \"Stefan Imhoff\""
...
namespace :fonts do
  ...
  task :compile do
    ...
    if $?.exitstatus == 0
      system 'bundle exec fontcustom compile'
      if $?.exitstatus == 0
