{embed="inc/html_head"}
    <title>{exp:weblog:entries require_entry="yes" status="open|vorschau" limit="1"}{title}{/exp:weblog:entries} • {exp:weblog:info weblog="notes"}{blog_title}{/exp:weblog:info} • {site_name}</title>
{embed="inc/favicon"}
