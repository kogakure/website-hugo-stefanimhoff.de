...
{% figure "Vim - Scheuermittel und Poliermittel. Erhellt das Heim und das Alter." %}
<img src="{{ 'artikel/vim-vintage.jpg' | asset_path }}" alt="Vim, Reinigungs- und Poliermittel.">
{% endfigure %}
