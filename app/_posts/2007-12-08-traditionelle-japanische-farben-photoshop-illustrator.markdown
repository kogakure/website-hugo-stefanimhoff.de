...
{% figure figure--noborder "Japanische Farbpalette für Adobe Illustrator und Photoshop" %}
<img src="{{ 'artikel/japanische-farben.png' | asset_path }}" alt="Japanische Farben" title="Japanische Farben" />
{% endfigure %}
