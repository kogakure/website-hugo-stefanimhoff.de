...
{% figure border "Der Detail-Screen eines Nahrungsmittels "%}
<img src="{{ site.images_dir }}fddb-info.png" alt="Screenshot von fddb.info" title="Der Detail-Screen eines Nahrungsmittels." />
{% endfigure %}
